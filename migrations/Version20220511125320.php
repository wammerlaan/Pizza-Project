 ...
 */
final class Version20220511125320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD size_id INT NOT NULL');
